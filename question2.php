...
function nonRecursiveLimit ($chars, $text) {
    while (strlen($text)>$chars) { // the total amount characters in the string is less than or equal to the amount specified
...
$text = nonRecursiveLimit (105, $text);
print_r($text);
